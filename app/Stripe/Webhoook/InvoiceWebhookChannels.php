...
class InvoiceWebhookChannels extends ProductWebhookChannels implements Channels
{
    ...
    /**
     * Trata o evento invoice.paid / invoice.payment_succeeded.
     */
    ...
    protected function handleInvoicePaidOrSucceeded(mixed $data, string $type): void
    {
        $eventId = $data['id'] ?? null;
        $stripeObject = $data['data']['object'] ?? [];
        $subscriptionId = is_string($stripeObject['subscription'] ?? null) ? $stripeObject['subscription'] : ($stripeObject['subscription']['id'] ?? null);
        $customerId = is_string($stripeObject['customer'] ?? null) ? $stripeObject['customer'] : ($stripeObject['customer']['id'] ?? null);
    ...
    /**
     * Trata o evento invoice.payment_failed quando um pagamento é recusado/falha.
     */
